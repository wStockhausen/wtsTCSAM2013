...
//--2013-09-18: Turned on RKC params for discard fishing mortality 1992+ (still hardwired)
//              made sure fmRKF is 0 when fishery closed
//********
//to run mcmc 
...
DATA_SECTION
 ...
 LOCAL_CALCS
    echo.open("EchoOut.txt", ios::trunc);
