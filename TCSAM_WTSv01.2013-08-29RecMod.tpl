...
//********
// 2013-08-29: changed pRecDevs indexing from 1974:endyr in new model to 1975:endyr to match up w/ rec_devf's in original model to explore
// differences in early recruitment levels between new model and orig model. Didn't account for differences, but did match up sequence 
// of devs.
//********
//to run mcmc 
...
PARAMETER_SECTION
    ...
    init_bounded_dev_vector pRecDevs(1975,endyr,-15,15,1)    // Deviations about mean recruitment 1975+ [IMPORTANT CHANGE: used to be "1974 to endyr-1" because rec(y) got added to nAtZ(y+1)]
    init_number pMnLnRecEarly(1)                             // Mean log-scale recruitment in early phase (pre-1975)
    init_bounded_dev_vector pRecDevsEarly(styr,1974,-15,15,1)// Deviations about logscale mean recruitment in early phase (pre-1975; had been pre-1974)
    ...
    init_bounded_dev_vector pFmDevsRKF(1,nobs_discardc_rkc,-15,15,-5) //this is NOT estimated (why?)  IMPORTANT CHANGE: was nobs_discardc_rkc-1.  why -1 in "nobs_discardc_rkc-1"
...
//    cout<<"get_numbers_at_len"<<endl;
    ...
    rec_y(styr,1974)  = mfexp(pMnLnRecEarly+pRecDevsEarly);
    rec_y(1975,endyr) = mfexp(pMnLnRec+pRecDevs);
//    cout<<"1"<<endl;
